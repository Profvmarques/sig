...
CREATE TABLE `acessousuario` (
  ...
  PRIMARY KEY (`idmenu`,`idusuarios`),
  KEY `idusuarios` (`idusuarios`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_general_ci;

INSERT INTO `acessousuario` VALUES (1,1,1,1,1,1,1);
INSERT INTO `acessousuario` VALUES (1,2,1,1,1,1,1);
INSERT INTO `acessousuario` VALUES (1,3,1,1,1,1,1);
INSERT INTO `acessousuario` VALUES (1,4,1,1,1,1,1);
INSERT INTO `acessousuario` VALUES (1,5,1,1,1,1,1);
INSERT INTO `acessousuario` VALUES (1,6,1,1,1,1,1);
INSERT INTO `acessousuario` VALUES (1,7,1,1,1,1,1);
INSERT INTO `acessousuario` VALUES (1,8,1,1,1,1,1);
INSERT INTO `acessousuario` VALUES (1,9,1,1,1,1,1);
INSERT INTO `acessousuario` VALUES (1,10,1,1,1,1,1);
INSERT INTO `acessousuario` VALUES (1,11,1,1,1,1,1);
INSERT INTO `acessousuario` VALUES (1,12,1,1,1,1,1);
...
INSERT INTO `chat` VALUES (1,'babydoe','johndoe','intiuiÃ§Ã£o\nsalvaÃ§Ã£o','2016-07-27 01:00:51',0);
INSERT INTO `chat` VALUES (2,'babydoe','johndoe','naÃ§Ã£o','2016-07-27 01:02:28',0);
INSERT INTO `chat` VALUES (3,'babydoe','johndoe','importaÃ§Ã£o','2016-07-27 01:04:14',0);
INSERT INTO `chat` VALUES (4,'babydoe','johndoe','zdsdsd','2016-07-27 01:12:42',0);
INSERT INTO `chat` VALUES (5,'babydoe','johndoe','oraÃ§Ã£o','2016-07-27 01:13:21',0);
INSERT INTO `chat` VALUES (6,'babydoe','johndoe','babação','2016-07-27 01:16:39',0);
INSERT INTO `chat` VALUES (7,'babydoe','johndoe','dd','2016-07-27 01:42:25',0);
INSERT INTO `chat` VALUES (8,'babydoe','vinny','teste de pariação','2016-07-27 01:50:18',0);
INSERT INTO `chat` VALUES (9,'babydoe','vinny','Débora','2016-07-27 01:50:25',0);
...
INSERT INTO `chat` VALUES (13,'babydoe','vinny','bláblá','2016-07-27 01:54:31',0);
...
INSERT INTO `configuracao` VALUES (2,1,1);
INSERT INTO `configuracao` VALUES (3,1,1);
INSERT INTO `configuracao` VALUES (4,1,1);
INSERT INTO `configuracao` VALUES (5,1,1);
INSERT INTO `configuracao` VALUES (6,1,1);
INSERT INTO `configuracao` VALUES (7,1,1);
INSERT INTO `configuracao` VALUES (8,1,1);
INSERT INTO `configuracao` VALUES (9,1,1);
INSERT INTO `configuracao` VALUES (10,1,1);
INSERT INTO `configuracao` VALUES (11,1,1);
INSERT INTO `configuracao` VALUES (12,1,1);
...
INSERT INTO `logs` VALUES (1,106,'insert into menu(idmodulos,id_pai,ordem,menu,class,url) values( :idmodulos, :id_pai, :ordem, :menu, :class, :url);','menu','Inserir','2016-08-04 14:51:52');
INSERT INTO `logs` VALUES (2,106,'insert into menu(idmodulos,id_pai,ordem,menu,class,url) values( :idmodulos, :id_pai, :ordem, :menu, :class, :url);','menu','Inserir','2016-08-04 14:51:52');
INSERT INTO `logs` VALUES (3,1,'insert into menu(idmodulos,id_pai,ordem,menu,class,url,idmenuSubmissao) values( :idmodulos, :id_pai, :ordem, :menu, :class, :url,:idmenuSubmissao);','menu','Inserir','2016-08-09 11:41:36');
INSERT INTO `logs` VALUES (4,1,'insert into menu(idmodulos,id_pai,ordem,menu,class,url,idmenuSubmissao) values( :idmodulos, :id_pai, :ordem, :menu, :class, :url,:idmenuSubmissao);','menu','Inserir','2016-08-09 15:03:49');
INSERT INTO `logs` VALUES (5,1,'insert into menu(idmodulos,id_pai,ordem,menu,class,url,idmenuSubmissao) values( :idmodulos, :id_pai, :ordem, :menu, :class, :url,:idmenuSubmissao);','menu','Inserir','2016-08-09 15:03:49');
INSERT INTO `logs` VALUES (6,1,'insert into menu(idmodulos,id_pai,ordem,menu,class,url,idmenuSubmissao) values( :idmodulos, :id_pai, :ordem, :menu, :class, :url,:idmenuSubmissao);','menu','Inserir','2016-08-09 15:03:50');
INSERT INTO `logs` VALUES (7,1,'insert into menu(idmodulos,id_pai,ordem,menu,class,url,idmenuSubmissao, publico) values( :idmodulos, :id_pai, :ordem, :menu, :class, :url,:idmenuSubmissao,:publico);','menu','Inserir','2016-08-09 15:21:10');
INSERT INTO `logs` VALUES (8,1,'insert into menu(idmodulos,id_pai,ordem,menu,class,url,idmenuSubmissao, publico) values( :idmodulos, :id_pai, :ordem, :menu, :class, :url,:idmenuSubmissao,:publico);','menu','Inserir','2016-08-09 15:21:10');
INSERT INTO `logs` VALUES (9,1,'insert into menu(idmodulos,id_pai,ordem,menu,class,url,idmenuSubmissao, publico) values( :idmodulos, :id_pai, :ordem, :menu, :class, :url,:idmenuSubmissao,:publico);','menu','Inserir','2016-08-09 15:21:11');
...
CREATE TABLE `menu` (
  ...
  `ordem` varchar(11) DEFAULT NULL,
  `idmodulos` int(11) DEFAULT NULL,
  `idmenuSubmissao` int(11) DEFAULT NULL,
...
INSERT INTO `menu` VALUES (1,0,'1',1,NULL,'Painel','entypo-window','#',1,'2016-08-04 14:51:51');
INSERT INTO `menu` VALUES (2,1,'1.1',1,1,'Cópia de Segurança(Backup)','entypo-database','backup.php',1,'2016-08-04 14:51:51');
INSERT INTO `menu` VALUES (3,1,'1.2',1,1,'Gerenciamento de Menu','entypo-layout','#',1,'2016-08-08 13:32:39');
INSERT INTO `menu` VALUES (4,2,'1.2.1',1,3,'Cadastro','entypo-doc-text-inv','default.php?pg=dmlzYW8vbWVudS9pbmNsdWlyLnBocA==&titulo=Q2FkYXN0cm8gZGUgTWVudQ==',1,'2016-08-08 15:13:01');
INSERT INTO `menu` VALUES (5,2,'1.2.2',1,3,'Consulta','entypo-search','#',1,'2016-08-08 15:30:58');
INSERT INTO `menu` VALUES (6,0,'2',1,NULL,'Sair','entypo-logout','logoff.php',1,'2016-08-09 11:41:33');
INSERT INTO `menu` VALUES (7,1,'1.3',1,1,'Gerenciamento de Módulos','entypo-layout','#',1,'2016-08-09 15:03:46');
INSERT INTO `menu` VALUES (8,1,'1.4',1,1,'Gerenciamento de Sistemas','entypo-layout','#',1,'2016-08-09 15:03:46');
INSERT INTO `menu` VALUES (9,1,'1.5',1,1,'Gerenciamento de Usuários','entypo-user','#',1,'2016-08-09 15:03:47');
INSERT INTO `menu` VALUES (10,2,'1.5.1',1,9,'Cadastro','entypo-doc-text-inv','#',1,'2016-08-09 15:21:07');
INSERT INTO `menu` VALUES (11,2,'1.5.2',1,9,'Consulta','entypo-search','#',1,'2016-08-09 15:21:07');
INSERT INTO `menu` VALUES (12,2,'1.5.3',1,9,'Configuração de Perfil','entypo-user','default.php?pg=dmlzYW8vY29uZmlndXJhY2FvL2luY2x1aXIucGhw&titulo=Q2FkYXN0cm8gUGVybWlzcyZhdGlsZGU7byBkZSBQZXJmaWwgZGUgVXN1JmFhY3V0ZTtyaW8=',1,'2016-08-09 15:21:08');
...
INSERT INTO `modulos` VALUES (1,1,'Conf','Configuração',NULL);
...
INSERT INTO `sistemas` VALUES (1,'SysFundec','SISTEMA DE GESTÃO ACADÊMICA DOS CURSOS PROFISSIONALIZANTES');
INSERT INTO `sistemas` VALUES (2,'SIC','SERVIÇO DE INFORMAÇÃO AO CIDADÃO');
INSERT INTO `sistemas` VALUES (3,'SOS','SISTEMA DE ORDEM DE SERVIÇO');
...
INSERT INTO `titulacao` VALUES (1,'GRADUAÇÃO');
INSERT INTO `titulacao` VALUES (2,'PÓS-GRADUAÇÃO(ESPECIALIZAÇÃO)');
INSERT INTO `titulacao` VALUES (3,'MESTRADO');
